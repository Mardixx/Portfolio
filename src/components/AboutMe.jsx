...
export const AboutMe = () => {
    return (
        <motion.div initial={{ opacity : 0 }} animate={{ opacity : 1 }} transition={{ duration : 2 }} className="aboutMe">
            ...
            <motion.div className="spanAboutMe" initial={{ scale : 0.2 }} animate={{ scale : 1.0 }} transition={{ duration : 0.5 }}><span>In this Portfolio, you will be able to find projects from the training I followed at BeCode Charleroi. 
